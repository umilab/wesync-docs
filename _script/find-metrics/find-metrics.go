// Copyright (C) 2023 The Wesync Authors.
//
...
//
// This script finds all of the metrics in the Wesync codebase and prints
...
func main() {
	...
	pkgs, err := packages.Load(opts, "github.com/umilab/wesync/...")
	if err != nil {
		log.Fatalln(err)
	}
