...
have sensitive documents here but they are in cleartext from Wesync's
...
wesync will usually do an efficient rename or at least copy all the data
...
Say you recovered a backup or lost the Wesync database on an untrusted
...
.. code-block:: bash
    ...
    $ wesync decrypt --to <plaintext-destination> --password <your-password> <encrypted-folder-path>
...
.. graphviz::
    ...
    graph {
        "folder" [shape=folder]
        "I.wesync-enc" [shape=folder]
        "KF" [shape=folder]
        "EDO9653D..." [shape=file]
        "S.wesync-enc" [shape=folder, color=grey]
        ...
        "I.wesync-enc" -- "KF"
        "KF" -- "EDO9653D..."
        "folder" -- "S.wesync-enc" [color=grey]
        "S.wesync-enc" -- "21" [color=grey]
