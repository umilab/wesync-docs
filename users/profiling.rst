...
``/rest/debug/cpuprof``. Assuming you are on the same computer as Wesync
...
``wesync-cpu-windows-amd64-v0.14.4-112233.pprof``. This is the file to
...
Assuming you are on the same computer as Wesync
and using the default settings, you should be able to do that by just
...
``wesync-heap-windows-amd64-v0.14.4-112233.pprof``. This is the file to
keep and send in, without modifying the file name as it tells us information
necessary to interpret it.
